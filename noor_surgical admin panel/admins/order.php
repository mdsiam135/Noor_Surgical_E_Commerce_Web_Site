...
<head>
    ...
    <title>noor surgical admin panel - order placed  page</title>
</head>
...
<?php include('../components/admin_header.php'); ?>
    ...
    <section class="order-container">
        ...
        <div class="box-container">
            ...
            ?>
            <div class="box">
                <div class="status" style="color: <?php if($fetch_orders['payment_status'] == 'complete'){echo "green";}else{echo "red";} ?>"><?= $fetch_orders['payment_status']; ?></div>
                <div class="detail">
